...
$l['slave_cant'] = '添加用户计划错误';
$l['slave_cant_exp'] = '不允许从服务器添加用户计划！';
$l['no_plan_name'] = '未指定用户计划名称';
$l['nousertype'] = '请选择用户类型';
$l['emailexist'] = '电子邮件地址已存在';
$l['no_new'] = '您未指定新密码';
...
$l['<title>'] = '添加用户计划';
$l['add_user'] = '添加用户计划';
$l['done'] = '用户计划已保存。返回<a href="'.$globals['index'].'act=user_plans">用户计划概览</a>';
$l['usertype'] = '用户类型';
$l['typeofuser'] = '用户类型';
$l['user_email'] = '用户电子邮件';
$l['exp_email'] = '用户的电子邮件地址';
$l['new_pass'] = '密码';
$l['pass_exp'] = '新用户的密码';
$l['submit'] = '保存计划';
$l['user_1'] = '管理员';
...
$l['user_0'] = '用户';
$l['plan_name'] = '计划名称';
$l['plan_name_exp'] = '用于参考的唯一名称';
$l['inhouse_billing'] = '启用Virtualizor计费';
$l['inhouse_billing_exp'] = '如果启用，Virtualizor将计算资源使用情况并为虚拟机创建发票。否则，您的外部计费系统应管理计费。<br />有关更多信息，请阅读<a href="'.$globals['docs'].'Virtualizor_Billing" target="_blank">Virtualizor计费</a>';
...
$l['cpu'] = '默认CPU权重';
$l['cpu_exp'] = '';
$l['cores'] = '每'.VM_SHORT.'的最大核心数';
$l['cores_exp'] = '用户无法创建超过此限制的'.VM_SHORT;
$l['space_per_vm'] = '每'.VM_SHORT.'的最大磁盘空间';
...
$l['cpu_percent_exp'] = '用户创建的所有'.VM_SHORT.'将具有此CPU百分比。这是每核心基础。例如，如果用户创建具有2个核心的'.VM_SHORT.'且百分比为40，则将分配总共80%。';
$l['num_ipv4'] = '最大IPv4';
$l['num_ipv4_exp'] = '';
$l['num_ip_int'] = '最大内部IP';
...
$l['allowed_virts_exp'] = '允许此用户的虚拟化类型';
$l['openvz'] = 'OpenVZ';
...
$l['proxo'] = 'Proxmox OpenVZ';
$l['proxo_exp'] = '允许用户创建Proxmox OpenVZ虚拟机';
$l['proxk'] = 'Proxmox Qemu/KVM';
$l['proxk_exp'] = '允许用户创建Proxmox Qemu/KVM虚拟机';
$l['proxl'] = 'Proxmox LXC';
$l['proxl_exp'] = '允许用户创建Proxmox LXC虚拟机';
$l['sg'] = '允许的服务器组';
...
$l['no_limit'] = '无限制';
$l['band_suspend'] = '带宽暂停';
$l['band_suspend_exp'] = '如果选中，则所有云用户的'.VM_SHORT.'将在超过指定的带宽限制时暂停';
